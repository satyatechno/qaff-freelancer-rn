...
class SelectCountry extends Component {
  ...
  render() {
    ...
    return (
      <>
        <Header
          title={i18n.t('asSelectCountry.editProfile')}
          backButton={true}
        ...
        {this.state.isLoading ? (
          ...
          <View style={styles.container}>
            <Text style={styles.label}>
              {i18n.t('asSelectCountry.selectCountry')}
            </Text>
            <TextInput
              style={styles.input}
              placeholder={i18n.t('asSelectCountry.searchCountry')}
              onChangeText={(text) => {
                this.Searching(text);
              }}
            />
            {noMatchFound ? (
              <View
                ...
                <Text>{i18n.t('asSelectCountry.noMatchFound')}</Text>
              </View>
            ) : (
              <ScrollView>
                <RadioGroup
