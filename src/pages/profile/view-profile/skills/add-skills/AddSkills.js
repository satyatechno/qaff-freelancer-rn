...
class AddSkills extends Component {
  ...
  addSkills = (item, index) => {
    ...
    if (doesSkillExist) {
      Snackbar.show({
        text: i18n.t('skills.skillsAlreadyAdded'),
        duration: Snackbar.LENGTH_SHORT,
      });
    } else if (this.state.selectedSkills.length > 9) {
      alert(i18n.t('skills.maximum10'));
    } else {
  ...
  render() {
    ...
    return (
      <>
        <Header
          title={i18n.t('skills.selectSkills')}
          backButton
          notificationButton
        ...
        <TextInput
          ...
          placeholder={i18n.t('skills.searchSkills')}
            ...
            this.state.skillsLoading ? (
              ...
              this.state.search && (
                <Text
                  ...
                  {i18n.t('skills.skillsNotMatched')}
                </Text>
              )
            )
          }
