...
class SelectEmploymentCountry extends Component {
  ...
  render() {
    ...
    return (
      <>
        <Header
          title={i18n.t('selectCountry.selectCountry')}
          backButton={true}
        ...
        {this.state.isLoading ? (
          ...
          <View style={styles.container}>
            <Text style={styles.label}>
              {i18n.t('selectCountry.selectACountry')}
            </Text>
            <TextInput
              style={styles.input}
              placeholder={i18n.t('selectCountry.searchCountry')}
              onChangeText={(text) => {
                this.Searching(text);
              }}
            />
            {noMatchFound ? (
              <View
                ...
                <Text>{i18n.t('selectCountry.noMatch')}</Text>
              </View>
            ) : (
              <ScrollView>
                <RadioGroup
